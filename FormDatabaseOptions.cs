...
namespace LecturaDeArchivos
{
    public partial class FormDataBaseOptions : Form
    {
        ...
        private List<string> GetStoredProceduresFromCurrentDatabase() => Utils.GetStoredProceduresFromCurrentDatabase(formMain.RemoteConnection, DataBaseName);
        ...
        private List<string> GetTablesFromCurrentDatabase()
        {
            ...
            return Utils.GetTablesFromCurrentDatabase(formMain.RemoteConnection, DataBaseName);
        }
        ...
        private void LoadTreeViewDatabase()
        {
            ...
            Utils.GetTablesFromCurrentDatabase(formMain.RemoteConnection, DataBaseName).ForEach(table => treeNodeTables.Nodes.Add(table));
